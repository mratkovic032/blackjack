                    ...
                    <div class="row login">
                        ...
                        <form action="php/register.php" method="POST">
                            <div class="col-md-8 col-md-offset-2 text-center">
                                ...
                                ?>
                                <input type="email" class="form-control login_inputs" name="email" placeholder="email" required/>
                                <br />
                                <input type="text" class="form-control login_inputs" name="username" placeholder="username" required/>
                                <br />
                                <input type="password" class="form-control login_inputs" name="password" placeholder="password" required/>
                                <br />
                                <input type="password" class="form-control login_inputs" name="password2" placeholder="re-type password" required/>
                                <br />
                                <select id="country_select" class="form-control login_inputs" name="country" class="form-control login_inputs">
                                ...
                                <br />
                                <input type="date" class="form-control login_inputs" name="birthday" required/>
                                <br />
